...
import seller3 from '../../assets/riya.png'
import seller4 from '../../assets/seller4.png'
import seller5 from '../../assets/harshita.png'
      ...
      <div className="header-slider">
       ...
       <Slider {...settings} className='slider'>
            <div className='slider-card'>
              ...
              <Link to={`/profile/Yuvraj Singh`}>
              <p className='slider-card-name'>Yuvraj Singh</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Vani`}>
              <p className='slider-card-name'>Vani</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Riya`}>
              <p className='slider-card-name'>Riya</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Garima`}>
              <p className='slider-card-name'>Garima</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Harshita`}>
              <p className='slider-card-name'>Harshita</p>
              </Link>
